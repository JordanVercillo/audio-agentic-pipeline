...
| **CI / quality gates** | GitHub Actions: `ruff` + `pytest` on every push & PR; 966 synthetic-data tests (no secrets, no network) |
...
pytest                                    # 966 tests — synthetic audio, no credentials, no network
```
