...
| **CI / quality gates** | GitHub Actions: `ruff` + `pytest` on every push & PR; 943 synthetic-data tests (no secrets, no network) |
...
pytest                                    # 943 tests — synthetic audio, no credentials, no network
```
