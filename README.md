...
| **CI / quality gates** | GitHub Actions: `ruff` + `pytest` on every push & PR; 975 synthetic-data tests (no secrets, no network) |
...
pytest                                    # 975 tests — synthetic audio, no credentials, no network
```
