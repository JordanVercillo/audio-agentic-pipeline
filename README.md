...
| **CI / quality gates** | GitHub Actions: `ruff` + `pytest` on every push & PR; 948 synthetic-data tests (no secrets, no network) |
...
pytest                                    # 948 tests — synthetic audio, no credentials, no network
```
