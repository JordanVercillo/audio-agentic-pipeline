...
**Author:** Jordan Vercillo · **Cost:** $0/month · **Tests:** 996 synthetic-only
...
| | |
|---|---|
| Acoustic corpus | **1965** analyzed tracks (grown by real users + playlist imports); **1,894** with a verified audio source shape every aggregate, 40 withheld until repaired |
...
| Tests | **996**, all synthetic-data — no credentials or network needed; CI green on every push |
